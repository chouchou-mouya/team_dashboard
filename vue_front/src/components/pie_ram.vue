    ...
    <div class="pie_ram">
        <h3>
            <svg width="30" height="30">
                <use xlink:href="#svghub_ramIcon"></use>
            </svg>
            RAM用量
        </h3>        
        <svg :style="{width:pieWidth,height:pieHeight}" id="pie_svg_ram"></svg>
    </div>
</template>
...
import d3_config from "./d3_config"
    ...
    export default {
        ...
        data(){
            return{
                cpu_link:"static/json/aisnd_ram.json",
        ...
        methods:{
            ...
            cpu_pie:function(data){
                ...
                let pie = d3.pie().sort(null)//是否排序
                        .value(function(d) {console.log(d); return d.value; });
                let svg = d3.select("#pie_svg_ram")
                            .append("g")
                ...
                svg.append("text")
                    .attr("x",function(d,i){
                        ...
                        return i*220-(self.pieWidth/2)+20
                    })
                    .attr("y",function(d,i){
